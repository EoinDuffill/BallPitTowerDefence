...
public:
	...
	/* Reset the vector to have a single NULL*/
	...
	/* Resize the Vector for more DisplayableObjects*/
	void ResizeVector(int increase);

	void pushBack(DisplayableObject* pObject);

	int getVectorSize();
	
	void eraseFromVector(DisplayableObject* pObject);

	void eraseIndexFromVector(int index);
...
public:
	...
	*/
	...
	void DrawBackgroundHollowOval(	int iX1, int iY1, int iX2, int iY2,
									int iX3, int iY3, int iX4, int iY4,
									unsigned int uiColour) {
		DrawHollowOval(iX1, iY1, iX2, iY2, iX3, iY3, iX4, iY4, uiColour, m_pBackgroundSurface);
	}

	void DrawScreenHollowOval(int iX1, int iY1, int iX2, int iY2,
		int iX3, int iY3, int iX4, int iY4,
		unsigned int uiColour) {
		DrawHollowOval(iX1, iY1, iX2, iY2, iX3, iY3, iX4, iY4, uiColour, m_pActualScreen);
	}
